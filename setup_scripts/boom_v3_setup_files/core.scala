...
//   "CSRFile is being written to spuriously.")
  ...
  if (COMMIT_LOG_PRINTF) {
    ...
    for (w <- 0 until coreWidth) {
      ...
      def printf_csr(csr: freechips.rocketchip.rocket.CSRFile) = {
        printf(" fflags 0x%x", csr.io.fflags.asUInt)
        printf(" frm 0x%x", csr.io.frm.asUInt)
        printf(" fcsr 0x%x", csr.io.fcsr.asUInt)       
    
        printf(" sstatus 0x%x", csr.io.status.asUInt(63, 0))
        printf(" sie 0x%x", csr.io.mie.asUInt)
        printf(" stvec 0x%x", csr.io.stvec.asUInt)
        printf(" scounteren 0x%x", csr.io.scounteren.asUInt)
        printf(" sscratch 0x%x", csr.io.sscratch.asUInt)
        printf(" sepc 0x%x", csr.io.sepc.asUInt)
        printf(" scause 0x%x", csr.io.scause.asUInt)
        printf(" stval 0x%x", csr.io.stval.asUInt)
        printf(" sip 0x%x", csr.io.mip.asUInt)
        printf(" satp 0x%x", csr.io.satp.asUInt)

        printf(" mstatus 0x%x", csr.io.status.asUInt(63, 0))
        printf(" misa 0x%x", csr.io.status.isa.asUInt)
        printf(" medeleg 0x%x", csr.io.medeleg.asUInt)
        printf(" mideleg 0x%x", csr.io.mideleg.asUInt)
        printf(" mie 0x%x", csr.io.mie.asUInt)
        printf(" mtvec 0x%x", csr.io.mtvec.asUInt)
        printf(" mscratch 0x%x", csr.io.mscratch.asUInt)
        printf(" mepc 0x%x", csr.io.mepc.asUInt)
        printf(" mcause 0x%x", csr.io.mcause.asUInt)
        printf(" mtval 0x%x", csr.io.mtval.asUInt)
        printf(" mip 0x%x", csr.io.mip.asUInt)
        printf(" minstret 0x%x", csr.io.minstret.asUInt)
//        printf(" pmpcfg0 0x%x", csr.io.pmpregs.asUInt)
//        printf(" pmpcfg1 0x%x", csr.io.status.asUInt)
//        printf(" pmpcfg2 0x%x", csr.io.status.asUInt)
//        printf(" pmpcfg3 0x%x", csr.io.status.asUInt)
//        printf(" pmpaddr0 0x%x", csr.io.status.asUInt)
//        printf(" pmpaddr1 0x%x", csr.io.status.asUInt)
//        printf(" pmpaddr2 0x%x", csr.io.status.asUInt)
//        printf(" pmpaddr3 0x%x", csr.io.status.asUInt)
//        printf(" pmpaddr4 0x%x", csr.io.status.asUInt)
//        printf(" pmpaddr5 0x%x", csr.io.status.asUInt)
//        printf(" pmpaddr6 0x%x", csr.io.status.asUInt)
//        printf(" pmpaddr7 0x%x", csr.io.status.asUInt)
//        printf(" pmpaddr8 0x%x", csr.io.status.asUInt)
//        printf(" pmpaddr9 0x%x", csr.io.status.asUInt)
//        printf(" pmpaddr10 0x%x", csr.io.status.asUInt)
//        printf(" pmpaddr11 0x%x", csr.io.status.asUInt)
//        printf(" pmpaddr12 0x%x", csr.io.status.asUInt)
//        printf(" pmpaddr13 0x%x", csr.io.status.asUInt)
//        printf(" pmpaddr14 0x%x", csr.io.status.asUInt)
//        printf(" pmpaddr15 0x%x", csr.io.status.asUInt)
        printf("\n")
      }
      ...
      when (rob.io.commit.arch_valids(w)) {
        ...
        //printf("value of pc 0x%x and if greater than 0x80 %d", rob.io.commit.uops(w).debug_pc(vaddrBits-1,0), (rob.io.commit.uops(w).debug_pc(vaddrBits-1,0) > 0x80000000L.U).asUInt)
        ...
        //when pc is greater than 0x80000000
        when (rob.io.commit.uops(w).debug_pc(vaddrBits-1,0) >= 0x80000000L.U){
            printf_csr(csr)
        } .otherwise {
            printf("\n")
        }
