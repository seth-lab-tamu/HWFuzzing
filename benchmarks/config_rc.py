"""
This is the config script for rocket core related settings
"""
import os
...
pt["core_dram_path"] = os.path.join(os.environ['THEHUZZ_ROOT'], 'benchmarks/rc_1130/dramsim2_ini') # copied from chipyard/generators/testchipip/src/main/resources
...
pt["dtb_file_path"] = os.path.join(os.environ['THEHUZZ_ROOT'], "benchmarks/rc_1130/rc.dtb")
...
core_full_name  = "Rocket"
isa = "riscv_1130" # for new version of chipyard
os = "bm"
...
top_instance = "TestDriver.testHarness.chiptop0.system.tile_prci_domain.element_reset_domain_rockettile"
...
# cov_sizes = {'line': 4214, 'branch': 4031, 'cond': 2820, 'fsm': 94, 'tgl': 227600}
cov_sizes = {'line': 4198, 'branch': 4084, 'cond': 22914, 'fsm': 59, 'tgl': 227470}
