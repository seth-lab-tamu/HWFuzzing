...
pt["core_dram_path"] = os.path.join(os.environ['THEHUZZ_ROOT'], 'benchmarks/rc/dramsim2_ini') # copied from chipyard/generators/testchipip/src/main/resources
...
pt["dtb_file_path"] = os.path.join(os.environ['THEHUZZ_ROOT'], "benchmarks/rc/rc.dtb")
...
# Coverage dimensions depend on the VCS version and are generated by noptest.
