...
pt["core_dram_path"] = os.path.join(os.environ['THEHUZZ_ROOT'], 'benchmarks/cva6/dramsim2_ini') # copied from chipyard/generators/testchipip/src/main/resources
# assert the core dram is present
# assert os.path.exists(pt["core_dram_path"]), f"Core dram path not found: {pt['core_dram_path']}"

pt["dtb_file_path"] = os.path.join(os.environ['THEHUZZ_ROOT'], "benchmarks/cva6/cva6.dtb")
