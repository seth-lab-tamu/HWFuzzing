...
pt["core_dram_path"] = os.path.join(os.environ['THEHUZZ_ROOT'], 'benchmarks/boomv4/dramsim2_ini') # copied from chipyard/generators/testchipip/src/main/resources
...
pt["dtb_file_path"] = os.path.join(os.environ['THEHUZZ_ROOT'], "benchmarks/boomv4/boomv4.dtb")
